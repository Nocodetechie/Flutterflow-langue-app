                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<List<InterestfieldRecord>>(
                        stream: queryInterestfieldRecord(),
                        builder: (context, snapshot) {
                          ...
                          List<InterestfieldRecord>
                              listViewInterestfieldRecordList = snapshot.data!;
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewInterestfieldRecordList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewInterestfieldRecord =
                                  listViewInterestfieldRecordList[
                                      listViewIndex];
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    49.0, 0.0, 0.0, 18.0),
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        final usersUpdateData =
                                          ...
                                          interest:
                                              listViewInterestfieldRecord.name,
                                        );
